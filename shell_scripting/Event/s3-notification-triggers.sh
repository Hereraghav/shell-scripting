...
bucket_name="raghav-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="mittalraghav95@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Raghav, i will soon be a DevOps engineer or software developer "
